...
if [ "$interactive" = true ]; then
  ...
  read -rp "$(echo -e "${yellow}• Enter file extensions to include ${cyan}(default: js ts tsx html css py go java c cpp cs rb rs lua php sh zsh md txt): ${reset}")" input_extensions
